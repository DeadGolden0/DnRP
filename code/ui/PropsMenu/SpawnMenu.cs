...
public partial class SpawnMenu : Panel
{
	...
	public SpawnMenu()
	{
		...
		StyleSheet.Load( "/ui/PropsMenu/SpawnMenu.scss" );
		...
		var left = Add.Panel( "left" );
		{
...

			{
				...
				tabs.AddButtonActive( "🔫 Armes", ( b ) => weapons.SetClass( "active", b ) );

				var ents = body.AddChild<EntityList>();
				tabs.AddButtonActive( "🚀 Entités", ( b ) => ents.SetClass( "active", b ) );

				var rp_ents = body.AddChild<DRPEntityList>();
				tabs.AddButtonActive( "👮 Entités RolePlay", ( b ) => rp_ents.SetClass( "active", b ) );

				var npcs = body.AddChild<SeatEntityList>();
				tabs.AddButtonActive( "🧙 NPCs", ( b ) => npcs.SetClass( "active", b ) );

				var vehicles = body.AddChild<VehiclesList>();
				tabs.AddButtonActive( "🚗 Vehicules", ( b ) => vehicles.SetClass( "active", b ) );
